function OutImg = LDANet_FeaExt_new(InImg,Te_idx_R,Te_idx_C,V,PCANet)
% =======INPUT=============
...
OutImg=PCA_output_Te_1(OutImg, Te_idx_R, Te_idx_C,PCANet.PatchSize,PCANet.NumFilters,V);
