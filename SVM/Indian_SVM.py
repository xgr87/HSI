...
dir = './datasets/'
data = loadmat(dir + 'Indian_pines.mat')
data_gt = loadmat(dir + 'Indian_pines_gt.mat')
spectral = data['indian_pines']
spectral_gt = data_gt['indian_pines_gt']
...
for randi in range(num):
    ...
    OA[randi], AA[randi], K[randi], accurperclass[:,
                                                  randi] = classficationresult(plabel, testlabels)
...
# np.savez(
#     dir + 'indian_SVM.npz', OA=OA, AA=AA, K=K,
#     accurperclass=accurperclass, plabel_SVM=plabel_SVM)
# torch.save([OA, AA, K, accurperclass, plabel_SVM, plabel_SVM], dir + 'indian_SVM.pt')