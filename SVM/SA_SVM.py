...
dir = './datasets/'
data = loadmat(dir + 'Salinas.mat')
data_gt = loadmat(dir + 'Salinas_gt.mat')
spectral = data['salinas']
spectral_gt = data_gt['salinas_gt']
...
# np.savez(
#     dir + 'Salinas_SVM.npz', OA=OA, AA=AA, K=K,
#     accurperclass=accurperclass, plabel_SVM=plabel_SVM)
# torch.save([OA, AA, K, accurperclass, plabel_SVM, plabel_SVM], dir + 'Salinas_SVM.pt')