function [penaltymat, iter] = ...
    naturalbsplinepen(basisobj, Lfdobj, rng, sparsewrd)
%NATURALBSPLINEPEN computes the natural bspline penalty matrix for penalty
%LFDOBJ. 
%  Arguments:
...
if ~strcmp(type, 'naturalbspline')
    error('basisobj not of type naturalbspline');
end
...
if uniquebreaks
    [nsplinemat,P]  =   naturalbsplineM(breaks, breaks, norder, nderiv, sparsewrd);
    prodmat         =   P'*prodmat*P ;
end
