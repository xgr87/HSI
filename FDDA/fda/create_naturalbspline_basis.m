function basisobj = create_naturalbspline_basis(rangeval, nbasis, norder, ...
                                         breaks, dropind)
...
%  last modified 13 August 2011 by Kris Villez based on
...
if isempty(nbasis) && ~isempty(breaks)
    ...
    nbasis  = nbreaks + norder - 2; % nbasis for regular B-splines
end
