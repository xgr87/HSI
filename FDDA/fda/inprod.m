...
if rng(1) < range1(1) || rng(1) < range2(1)
    error('RNG(1) less than range(1) for FDOBJ1 and/or FDOBJ2.');
end
if rng(2) > range1(2) || rng(2) > range2(2)
    error('RNG(2) greater than range(2) for FDOBJ1 and/or FDOBJ2.');
end
