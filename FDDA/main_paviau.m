...
%     eval(['save paviau_result',num2str(r), ' plabel_OSVM plabel_FSVM plabel_PCA plabel_FPCA plabel_LDA plabel_FDA OA AA K accurperclass']); % 注意' plabel_OSVM之间的空格
end
% toc;
delete(gcp);